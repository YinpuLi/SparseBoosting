...
# Based on GB4.jl
# update: inital trial for adding tree prior:
        # added a tree prior for leaf mean parameters, μ_lb ∼ N(0, τ)
            # so the pointwise prior variance of f is τL.
        # added a tree prior for noise, ϵ ∼ N(0, σ)

        # so that the splitting criteria in _split! is changeed
...
##################### PART 0: Adding a Bayesian Prior ##################
